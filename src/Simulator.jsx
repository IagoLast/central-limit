...
var Simulator = React.createClass({
  ...
  getControls() {
    ...
    var samplingButtonText = this.state.currentlySampling == true ? 'Parar de tomar muestras' : 'Tomar Multiples muestras';
    var controls = this.props.controls.map(function (d) {
      switch (d) {
        case 'one_sample':
          var button = { id: "one_sample", text: "Muestreo Simple", onClick: this.sample };
          break;
  ...
  render() {
    ...
    var popDensityText = [{ key: 'popText', className: "popLabel", x: popMean, y: -2, text: "Media Poblacion" }];
    ...
    if (sampleMean != null) {
      ...
      popDensityText = popDensityText.concat({ key: 'sampleText', className: "sampleLabel", x: sampleMean, y: 1.5 * this.state.circleHeight + 2, text: "Media Muestra" });
    };
    ...
    if (meanOfMeans != null) {
      ...
      sampleDensityText = [{ key: 'sampleText', className: "sampleLabel", x: meanOfMeans, y: -2, text: "Media de  las Medias Muestrales" }];
    };
